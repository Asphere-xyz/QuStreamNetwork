...
export const QST = 1_000_000_000_000_000_000n;
export const MIN_QST_STAKING = 1000n * QST;
export const MIN_QST_NOMINATOR = 5n * QST;
export const DEFAULT_GENESIS_BALANCE = 2n ** 80n;
export const DEFAULT_GENESIS_STAKING = 1_000n * QST;
