...
import { verifyLatestBlockFees } from "../../../../helpers/index.js";
import {
  type RawXcmMessage,
  XcmFragment,
...
describeSuite({
  ...
  testCases: ({ context, it }) => {
    ...
    beforeAll(async () => {
      ...
      // Add asset to weight trader with unitsPerSecond = 1
      ...
      const relativePrice =
        (BigInt(nativeAmountPerSecond.toString()) * 10n ** relativePriceDecimals) / 1n;
